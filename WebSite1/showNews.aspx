<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="showNews.aspx.cs" Inherits="Jgsz" %>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Id" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" ShowHeader="False" Width="100%">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="T1" SortExpression="T1">
                ...
                <ItemTemplate>
                <a href="News.aspx?QQ=<%# Eval("Id") %>"><asp:Label ID="Label1" runat="server" Text='<%# Bind("T1") %>'></asp:Label></a>
                </ItemTemplate>
